...
function SoundbarItems({searchTerm}) {
...
const filteredItems = SoundbarItem.filter((item) =>
searchTerm ? item.name.toLowerCase().includes(searchTerm.toLowerCase()) : true
    ...
    <div className=' relative border w-[32%] rounded-xl bg-[#fafafa] flex p-1'>
                <div className='w-[40%] mb-2 relative'>
                    <img src="src\assets\images\sound-bar\AB-Raga.png" alt="Airpode-131" className='w-[100%] rounded-lg'/>
                </div>
                <div>
