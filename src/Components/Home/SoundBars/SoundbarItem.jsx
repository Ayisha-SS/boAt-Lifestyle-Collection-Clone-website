    ...
    {item.map((item) => {
        return (
            ...
            <div>
                ...
                <span className='absolute justify-center  bottom-36 z-[1] left-[15%] text-center border-1 border-solid border-black rounded-2xl py-1.5 w-[70%] text-xs font-bold bg-yellow-500 text-black tracking-tight'>{item.sound}</span>
            </div>
            <div className="h-80 w-[100%] rounded-t-2x ">
                <img src="src\assets\images\sound-bar\AB_558.jpg" alt="Airpode-131" className='w-[100%]'/>
            </div>
