    ...
    <div className='pt-5 '>
        ...
        <div className='p-3 flex flex-col h-[100%] w-[25%] translate-x-0 transition ease-[cubic-bezier(0.75,0,1.75,1)] bg-white  left-0 z-10 top-0 fixed'>
          <div className='flex justify-between'>
            <span className='flex text-xl font-bold cursor-default'><PiArrowsLeftRightDuotone className='mr-2'/>Filter By</span>
            <span className='text-4xl flex justify-center items-center w-8 h-8 bg-[#d0d9dE] rounded-full cursor-pointer' onClick={() => setModal(false)}>&times;</span>
          </div>
          <div className='mt-6 overflow-y-auto'>
            ...
            <div></div>
            <div className='pt-12'>
              <button className='w-[40%] py-4 bg-[#D0D9DE] mr-2 rounded-xl'>Clear All</button>
              <button className='w-[40%] py-4 bg-black text-white rounded-xl'>Apply Filter</button>
            </div>
          </div>
        </div>
        )}
