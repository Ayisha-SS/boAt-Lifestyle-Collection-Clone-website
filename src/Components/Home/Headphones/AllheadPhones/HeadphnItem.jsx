...
import HeadphnItems from "./HeadphnItem.json"
import { Cart } from '../../../Context/Context'

function HeadphnItem({searchTerm}) {
...
const filteredItems = HeadphnItems.filter((item) =>
searchTerm ? item.name.toLowerCase().includes(searchTerm.toLowerCase()) : true
    ...
    <div className=' relative border w-[32%] rounded-xl bg-[#fafafa] flex p-1'>
                <div className='w-[40%] mb-2 relative'>
                    <img src="src\assets\images\Headphones\Immortal_200.jpg" alt="Airpode-131" className='w-[100%] rounded-lg'/>
                </div>
                <div>
