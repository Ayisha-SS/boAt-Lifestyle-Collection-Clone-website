...
// import items from "./Watch.json";
import watch from "../Home.json"
import {Link} from "react-router-dom";

function WatchItem({item,searchTerm,setTerm}) {
    ...
    <>
      ...
      <div className='pt-5'>
        <div className="flex justify-between mb-3 ">
          ...
          <Link to="smart-watch" className='text-xs flex text-blue-800'>View All <IoArrowForwardCircleOutline size={16}/></Link>
        </div>
            ...
            return (
              <div key={item.id} className='outline-none w-[25%] flex flex-col relative rounded-2xl shadow-xl'>
                ...
                <div className="h-80 w-[100%] rounded-t-3x ">
                  <img src="src\assets\images\Watch\Wave_Astra.webp" alt={item.name} className='w-[100%] rounded-lg' />
                </div>
