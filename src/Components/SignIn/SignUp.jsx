  ...
  return (
    <div className='bg-[#313131cc] h-[100%] w-[100%] fixed top-0 bottom-0 right-0 left-0 z-10'>
        ...
        <div className='mt-[80px] flex flex-col p-4 bg-[#fafafa] z-10 max-w-[580px] w-[100%]  absolute right-20'>
            ...
            <div className='mb-[10px]  '>
                <input type="email" placeholder='Email' ref={email} className='p-3 w-[100%] text-lg bg-slate-200'
                />
            </div>
            <div className='mb-[10px]  '>
                <input type="password" placeholder='Password' ref={password} className='p-3 w-[100%] text-lg bg-slate-200'
                />
            </div>
